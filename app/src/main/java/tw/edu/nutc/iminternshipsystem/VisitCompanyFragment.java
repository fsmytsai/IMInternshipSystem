 ...
 */
public class VisitCompanyFragment extends MySharedFragment {
    private AddVisitRecordActivity addVisitRecordActivity;

    public VisitCompanyView visitCompanyView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_visit_company, container, false);
    ...
    private void initView(View view) {
        ...
        rv_VisitCompanyQList = (RecyclerView) view.findViewById(R.id.rv_VisitCompanyQList);
    ...
    private void GetVisitStudentData() {
        Request request = new Request.Builder()
                .url(getString(R.string.BackEndPath) + "api/getNullComInterview?SCid=" + SCid)
                .build();
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                addVisitRecordActivity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (StatusCode == 200) {
                            visitCompanyView = new Gson().fromJson(ResMsg, VisitCompanyView.class);
                            answerArray = new int[visitCompanyView.InterviewQ.size()];
                            rv_VisitCompanyQList.setLayoutManager(new LinearLayoutManager(addVisitRecordActivity, LinearLayoutManager.VERTICAL, false));
    ...
    public class VisitCompanyAdapter extends RecyclerView.Adapter<VisitCompanyAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            if (getItemViewType(position) == TYPE_HEADER) {
                holder.tv_CompanyName.setText(visitCompanyView.comName);
                holder.tv_CompanyTel.setText(visitCompanyView.comTel);
                holder.tv_StudentName.setText(visitCompanyView.stuName);
                holder.tv_CompanyAddress.setText(visitCompanyView.comAddress);
            ...
            final VisitCompanyView.Question question = visitCompanyView.InterviewQ.get(Position);
        ...
        public int getItemCount() {
            int NormalCount = visitCompanyView.InterviewQ.size();
            if (mHeaderId != 0)
                NormalCount++;
            if (mFooterId != 0)
                NormalCount++;
...
//                rb_11 = (RadioButton) itemView.findViewById(R.id.rb_11);
    ...
    private void CreateStudentVisit() {
        ...
        RequestBody formBody = new FormBody.Builder()
                .add("SCid", SCid + "")
                .add("insCDate", visitDate)
                .add("insCNum", studentCount)
                .add("insCVisitWay", visitWay + "")
                .add("insCComments", visitComment + "")
                .add("insCAns", Answer)
                .add("insCQuestionVer", visitCompanyView.InterviewQ.get(0).insCQuestionVer + "")
                .build();

        Request request = new Request.Builder()
                .url(getString(R.string.BackEndPath) + "api/teacherCreateComInterview")
                .post(formBody)
                .build();
